...
class NavBar extends React.Component {
    ...
    render() {
        return(   
                  <nav>
                    <div className="logo"><a href="#"><img id="logo" src={"./img/LogoMakr-4Ocmnm.png"} ></img></a></div>
                    ...
                    <div className="div4"><button className="newnote" type="submit" value="newnote">New Note</button></div>
                  </nav>
            ...
            <main>
                ...
                <div id="notes">
                    <div id="note1">
                        ...
                        <div id="butt">
                            <a href="#"><button type="submit" value="edit">edit</button></a>
                            <a href="#"><button type="submit" value="delete">delete</button></a>
                        </div>
                    </div>
                    <div id="note2"></div>
                    <div id="note3"></div>
